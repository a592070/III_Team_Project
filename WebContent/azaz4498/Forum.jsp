...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav mr-auto">
				<li class="nav-item active"><a class="nav-link" href="#">主頁
				...
				<li class="nav-item dropdown"><a
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						<a class="dropdown-item" href="#">景點</a> <a class="dropdown-item"
							href="#">美食</a> <a class="dropdown-item" href="#">住宿</a>
					</div></li>
				<li class="nav-item "><a class="nav-link " href="#"
					aria-disabled="true">撰寫文章</a></li>
			</ul>
		</div>
	</nav>
	...
	<div class="card-group">
		...
		<h5 class="card-title">${art.artTitle}</h5>
			<img src="azaz4498\img\sc_01.jpg" class="card-img-top" alt="...">
			<div class="card-body">
				<h5 class="card-title">
