        ...
        <div class="container">
            ...
            <div class="">
                <div class="div-1">
                    ...
                    <textarea name="address" id="" cols="40" rows="5" placeholder="${r_hp.opentime}"></textarea>
                </div>

                <div class="div-1">
                    <label for="r-date">餐廳描述</label> 
                    <textarea name="transportation" id="" cols="40" rows="5" placeholder="${r_hp.description}"></textarea>
                </div>
