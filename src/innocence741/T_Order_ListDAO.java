...
public class T_Order_ListDAO {
	...
	public void createOrder(OrderTableBean bean) throws SQLException {
		...
		String sqlT_Order_LiString = "insert into T_ORDER_LIST (ORDER_ID, SN_SCHEDULE, TICKETPRICE, NUMBERS_DAYS, STARTPOINT, DESTINATION, DEPARTUREDATE, ORDER_TYPE, NAME, PHONE) values(?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
