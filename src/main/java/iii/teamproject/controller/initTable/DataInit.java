package iii.teamproject.controller.initTable;
...
public class DataInit {
    ...
    public List<AttractionsDO> getListDO() throws IOException {
        getJsonString();
        ...
        List<AttractionsDO> list = mapper.readerForListOf(AttractionsDO.class).readValue(info);
